...
class AudioUtil():
    ...
    def get_zrc(aud):
        ...
        zcr = librosa.feature.zero_crossing_rate(
            sig.numpy(), frame_length=4000, hop_length=2000)
    ...
    def get_spec(aud):
        ...
        spectral_centroids = librosa.feature.spectral_centroid(
            y=sig.numpy(), sr=4000, n_fft=200, hop_length=100)[0]
        spec_bw = librosa.feature.spectral_bandwidth(
            y=sig.numpy(), sr=4000, n_fft=200, hop_length=100)
